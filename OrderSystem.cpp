...
int main()
{
    ...
    getline(cin, Full_Name); // instead na cin >> First_Name >> Last_Name getline nalang para sa mahaba ang pangalan natatapos kasi prog pag sobra
    ...
    cin >> ID_Type; // same din na long long int para di matapos agad program
    ...
    cout << "Contact No#: "; // pa fix nalang yung sagot sa 11 digit num hahhahaha
    cin >> Contact_Number;   //dito naman ginawa kong long long int para mas malaki kaya niyang ienter ng num kasi diba 0917******** since may limit ang kayang hold
    ...
    string product;
    int productNum, qty, Jacketqty = false, Tumblerqty = false, Tshirtqty = false, Capqty = false, Lanyardqty = false;
    ...
    char choice;
    bool activateJacket = 0, activateTumbler = 0, activateTshirt = 0, activateCap = 0, activateLanyard = 0;
    ...
    totalCalulated = totalJacket + totalTumbler + totalTee + totalCap + totalLanyard;

    cout << "\n+-----------------------------------------------------------------------------------------------------------------------+";

    //para pag nag display ng price may .00 kasi pag wala whole number lang lalabas
    ...
    int Mode_of_Payment;
    string MOD = " ";
    cout << "\n\nWhat is your Mode of Payment? [Choose from 1 - 4] ";
    cin >> Mode_of_Payment;
    ...
    cout << "\n\t\t\t|\t\t                          \t\t    |";
    cout << "\n\t\t\t|   REF NO# " << refNum << "\t\t\t\t\t    |";
    cout << "\n\t\t\t|   DATE: " << ltm->tm_mon << "/" << ltm->tm_mday << "/" << ltm->tm_year + 1900 << "\t\t\t\t\t    |";
